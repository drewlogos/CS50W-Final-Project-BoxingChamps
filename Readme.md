...
This project is the result of months of curiosity, experimentation, and problem-solving that grew beyond its initial idea. I wanted to see how far I could push Django, a framework usually used for content-driven websites, into behaving like a living, responsive game. The result is this browser-based boxing RPG that merges backend logic with dynamic front-end interactivity. It’s a project I’m genuinely proud of because it challenged me to connect everything I had learned about databases, server communication, and user experience into one cohesive system that works in real time.
